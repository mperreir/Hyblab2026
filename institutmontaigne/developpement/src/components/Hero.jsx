  ...
  return (
    ...
    >
        ...
        <div className='flex w-full max-w-4xl flex-col items-center justify-center bg-[#E3F280] p-5 pt-8 rounded-xl'>
          ...
          <div className='flex relative items-start justify-center gap-2 sm:gap-6 flex-nowrap w-full my-7'>

            <img
              src={`${PATH_PUBLIC}/img/enveloppe.png`}
              className='absolute top-0 left-1/2 -translate-x-1/2 z-0 pointer-events-none size-[8rem] sm:size-[10rem] md:size-[12rem]'
              alt=''
            ></img>

            {/* Intervenant 1 */}
            <div className="relative z-10 flex flex-col items-center justify-center w-[clamp(110px,38vw,220px)]">
              ...
              <div className="relative flex items-center justify-center w-full">
                  <svg className="w-full h-auto" viewBox="0 0 166 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="w-full absolute text-center text-white font-bold text-xs sm:text-sm print:!text-white print-force-white">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center w-[clamp(110px,38vw,220px)]">
              ...
              <div className="relative flex items-center justify-center w-full">
                  <svg className="w-full h-auto" viewBox="0 0 147 43" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='flex justify-between items-center gap-2 w-full text-xs sm:text-sm'>
            <span className='px-2 rounded-full border-[#872339] border-2 text-[#872339] whitespace-nowrap'>
              {meta.type}
            </span>
            <span className='text-[#872339] text-right'>
              {meta.dateFormat}
            </span>
          </div>
        </div>
        ...
        <svg
          className={"w-4 h-3 mt-5 shrink-0 mx-auto text-gray-500"}
            viewBox="0 0 14 8"
            fill="none"
            stroke="currentColor"
            strokeWidth="2.5"
          ...
          style={{ animation: 'arrowFloatFade 1.6s ease-in-out infinite' }}
        >
